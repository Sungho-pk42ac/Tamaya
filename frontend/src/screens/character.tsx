  ...
  return (
    ...
    >
      ...
      >
        <svg width="100%" height="100%" viewBox="0 0 375 360" preserveAspectRatio="none">
          ...
          <ellipse
            ...
            strokeWidth="2"
          />
          <path d="M60 282 Q 80 274 100 282" stroke="#3a2414" strokeWidth="1.5" fill="none" />
      ...
      <div style={{ position: 'absolute', top: 408, left: 18, right: 18 }}>
        <div className="hbox r-l" style={{ padding: 12, background: '#f5e6cf', color: '#3a2414' }}>
        ...
        <div style={{ display: 'flex', gap: 8, overflowX: 'hidden' }}>
          {(
            ...
            >
              ...
              <div style={{ fontFamily: 'Patrick Hand', fontWeight: 700, fontSize: 13 }}>× {c}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 88px' }}>
        ...
        <div className="hbox r-l" style={{ padding: 14, marginTop: 14, background: '#fff5e1' }}>
