  ...
  return (
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 24px' }}>
        ...
        <div className="hbox r-r" style={{ padding: 16, marginTop: 12, background: '#fff5e1' }}>
          <div
            className="handwriting"
            style={{ fontSize: 18, lineHeight: 1.6, whiteSpace: 'pre-wrap' }}
          >
            {entry.body}
          </div>
        </div>
...
export const S16_Stats = () => {
  ...
  const life: [string, string, string][] = [
    [
      '🍚 식사',
      `${s.life.food}/${s.writeDays}`,
      s.life.food >= s.writeDays * 0.7 ? '꾸준 ↑' : '보통',
    ],
    [
      '😴 수면',
      `${s.life.sleep}/${s.writeDays}`,
      s.life.sleep >= s.writeDays * 0.6 ? '양호' : '부족 ↓',
    ],
    [
      '🚶 운동',
      `${s.life.movement}/${s.writeDays}`,
      s.life.movement >= s.writeDays * 0.5 ? '활발' : '보통',
    ],
  ];
  return (
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 88px' }}>
        ...
        <div className="hbox r-r" style={{ padding: 14, marginTop: 12 }}>
          ...
          >
            {life.map(([t, v, sub], i) => (
              <div key={i} className="hbox dashed" style={{ padding: 8, textAlign: 'center' }}>
    ...
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 88px' }}>
        ...
        <div className="hbox night r-l" style={{ padding: 16, marginTop: 14 }}>
          ...
          <div className="h-title" style={{ color: '#f5e6cf', fontSize: 22, marginTop: 4 }}>
            "5분의 틈"이 있던 날엔
            <br />
            피곤이 절반이었어 ⌇
          </div>
          <div className="handwriting" style={{ color: '#d8a777', fontSize: 16, marginTop: 8 }}>
