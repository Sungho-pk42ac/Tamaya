    ...
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 88px' }}>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontFamily: 'Patrick Hand', fontWeight: 700 }}>AI 코칭에게 물어봐요</div>
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 88px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginTop: 10 }}>
          <div className="hbox r-r" style={{ padding: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <div className="ph-circle" style={{ width: 32, height: 32 }}>
                💧
              </div>
              <div>
          ...
          <div className="hbox r-l" style={{ padding: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <div>
                ...
                <div className="tiny">{d.sun.level ?? '바깥 공기 쐰 시간'}</div>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 4, marginTop: 8 }}>
              {['☁', '☼', '☼☼'].map((t) => (
        ...
        {doneCount === 5 && (
          <div className="hbox accent" style={{ padding: 12, marginTop: 14, textAlign: 'center' }}>
            <div className="h-title" style={{ fontSize: 18 }}>
              오늘 5체크 완성! 🎉
            </div>
  ...
  return (
    <div className="phone-inner">
      ...
      <div ref={scrollRef} className="phone-scroll" style={{ padding: '46px 14px 140px' }}>
          ...
          {state.aiChat.map((m, i) =>
            m.role === 'bot' ? (
              <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                <div
                  className="ph-circle"
                  style={{ width: 28, height: 28, fontSize: 11, flex: 'none' }}
                >
                  ✦
                </div>
        ...
        <div className="h-label" style={{ marginTop: 18, marginBottom: 6 }}>
          자주 묻는 것
        </div>
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          {quick.map((t, i) => (
