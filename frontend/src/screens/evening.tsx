...
import { CHAT_DIARY_INTRO, CHAT_DIARY_TURNS, TODAY_DAY, useStore } from '../lib/store';
  ...
  return (
    ...
    >
      ...
      <div className="phone-scroll" style={{ padding: '60px 24px 100px' }}>
        ...
        <div className="handwriting" style={{ color: '#d8a777', marginTop: 10, fontSize: 20 }}>
          5분이면 충분해 · 5턴 대화
        </div>
            ...
            m.role === 'bot' ? (
              <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                ...
                <div className="hbox" style={{ padding: '10px 12px', maxWidth: 280 }}>
                  ...
                  {m.hint && (
                    <div className="tiny" style={{ marginTop: 4, color: '#8c4a1f' }}>
                      {m.hint}
                    </div>
                  )}
                </div>
  ...
  return (
    <div className="phone-inner">
      ...
      <div className="phone-scroll" style={{ padding: '46px 18px 80px' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
              {(
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <div className="ph-circle" style={{ width: 12, height: 12, background: c }} />
        ...
        <div className="hbox r-r" style={{ padding: 14, marginTop: 12, background: '#fff5e1' }}>
